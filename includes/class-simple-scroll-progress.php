...
class Simple_Scroll_Progress {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Simple_Scroll_Progress_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Simple_Scroll_Progress_Loader. Orchestrates the hooks of the plugin.
	 * - Simple_Scroll_Progress_i18n. Defines internationalization functionality.
	 * - Simple_Scroll_Progress_Admin. Defines all hooks for the admin area.
	 * - Simple_Scroll_Progress_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-simple-scroll-progress-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-simple-scroll-progress-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-simple-scroll-progress-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-simple-scroll-progress-public.php';

		$this->loader = new Simple_Scroll_Progress_Loader();
	 ...
	 *
	 * Uses the Simple_Scroll_Progress_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Simple_Scroll_Progress_i18n();
	...
	*/
	 ...
	 *
	 * @since     1.0.0
	 * @return    Simple_Scroll_Progress_Loader    Orchestrates the hooks of the plugin.
	 */
